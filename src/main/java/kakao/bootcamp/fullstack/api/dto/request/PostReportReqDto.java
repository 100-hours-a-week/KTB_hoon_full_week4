...
public record PostReportReqDto(
        @NotNull(message = ValidationCode.REPORT_TARGET_REQUIRED) Long targetId,
        @NotNull(message = ValidationCode.REPORT_TARGET_REQUIRED) TargetType targetType,
        @NotNull(message = ValidationCode.REPORT_REASON_REQUIRED) ReportReason reportReason) {}
