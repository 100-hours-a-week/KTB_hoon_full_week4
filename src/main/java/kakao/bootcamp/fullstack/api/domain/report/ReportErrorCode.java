...
public enum ReportErrorCode implements BaseCode {
    REPORT_TARGET_REQUIRED(
            HttpStatus.BAD_REQUEST, "REPORT_TARGET_REQUIRED", "report_target_required"),
    REPORT_REASON_REQUIRED(
            HttpStatus.BAD_REQUEST, "REPORT_REASON_REQUIRED", "report_reason_required"),
    SELF_REPORT_NOT_ALLOWED(
            HttpStatus.BAD_REQUEST, "SELF_REPORT_NOT_ALLOWED", "self_report_not_allowed"),
