...
public class WithMockAuthMemberSecurityContextFactory
        implements WithSecurityContextFactory<WithMockAuthMember> {

    @Override
    public SecurityContext createSecurityContext(WithMockAuthMember annotation) {
        SecurityContext context = SecurityContextHolder.createEmptyContext();
        AuthMember principal =
                new AuthMember(annotation.memberId(), annotation.email(), annotation.role());
        Authentication auth =
